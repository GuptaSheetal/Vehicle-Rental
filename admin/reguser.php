...
$queryy=mysqli_query($conn,"select u_id,first_name,last_name,email,contact,addhar,age,city,drvng_lic_no from user ");
?>
...
while($row=mysqli_fetch_array($queryy))
{
	?>	
										<tr>
											...
											<td><?php echo $row['addhar'];?></td>
											<td><?php echo $row['age'];?></td>
											<td><?php echo $row['city'];?></td>
											<td><?php echo $row['drvng_lic_no'];?></td>
										</tr>	
<?php
echo "</tr>";
$i++;
