...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
  ...
  <a class="navbar-brand" href="#"> 
      <img src="images/headerlogo.jpg" alt="" width="40" height="35" class="d-inline-block align-top">
      VEHICLE RENTAL
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="bikelist.php">Vehicle</a>
        </li>
        <li class="nav-item">
...
<div id="id01" class="modal">
  ...
  <form id="login" class="modal-content animate" action="index.php" method="post">
    ...
    <div class="container" style="background-color:#f1f1f1">
      ...
      <span class="psw"><a href="reg.php">New user Login?</a></span>
	  <span class="psw"><a href="admin/adminlogin.php">Admin Login</a></span>
    </div>
  </form>
</div>
<!--/Login -->
