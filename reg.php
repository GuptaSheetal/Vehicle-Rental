...
echo "<script>window.alert('Registration Done Successfully ');</script>";
...
<div class="signup-form" style="margin-top:70px">
    <form action="reg.php" method="post">
        ...
        <div class="form-group">
			<div class="row">
				<div class="col"><input type="text" class="form-control" name="f_name" placeholder="First Name"  onkeypress="return lettersOnly(event)" required="required"></div>
				<div class="col"><input type="text" class="form-control" name="l_name" placeholder="Last Name"  onkeypress="return lettersOnly(event)" required="required"></div>
			</div>        	
        </div>
             <div class="form-group">
            <input type="number" class="form-control" name="age" placeholder="Age" required="required">
             ...
             <div class="form-group">
            <input type="number" class="form-control" name="contact" placeholder="Contact-No" onkeypress="return numberonly(event)" required="required">
        </div> 
             <div class="form-group">
            <input type="number" class="form-control" name="addhar" placeholder="Aadhar Card-No" required="required">
        </div>
            <div class="form-group">
